namespace EventBusImplementation
{
    ...
    public class SetObjectActive : Task
    {
        GameObject mObject;

        public SetObjectActive(GameObject gameObject)
        {
            mObject = gameObject;
        }
        ...
        public override void run()
        {
            ...
            succeeded = mObject.activeSelf;
            EventBus.TriggerEvent(TaskFinished);
        }
    }

    public class SetObjectInactive : Task
    {
        GameObject mObject;

        public SetObjectInactive(GameObject gameObject)
        {
            mObject = gameObject;
        }
    ...
    public class UnlockDoor : Task
    {
        Door mDoor;

        public UnlockDoor(Door aDoor)
        {
            mDoor = aDoor;
        }
